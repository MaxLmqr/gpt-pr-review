...
export const baseContentGPT = `Please review the following code snippet, assuming the developer is experienced and knowledgeable. Focus your evaluation on adherence to coding best practices, readability, and style, without considering the functionality or potential future issues of the code. Do not explain what the code is doing functionally. Rate the code on a scale from 1 to 100, where 1 is the worst and 100 is the best. Provide a brief comment on areas of improvement if the rating is below 80; otherwise, respond with 'No comment.`
